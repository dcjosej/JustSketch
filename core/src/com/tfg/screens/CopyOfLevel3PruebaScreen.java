...
public class CopyOfLevel3PruebaScreen extends InputAdapter implements Screen,
		ContactListener {
	...
	public CopyOfLevel3PruebaScreen() {
	}
	...
	private void setupMapStaff() {
		...
		for (MapObject m : map.getLayers().get("Flags").getObjects()) {
			RectangleMapObject tiledPlatform = (RectangleMapObject) m;
